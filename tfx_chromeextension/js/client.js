...
function load()
{
   ...
   /// gapi.client.setApiKey('XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
    //Our key : AIzaSyAnPxrh7veHDrDaPjoTRJJV7GoqIoIYgOw
     gapi.client.setApiKey('AIzaSyAnPxrh7veHDrDaPjoTRJJV7GoqIoIYgOw');
