...
},{"attachmediastream":5,"mockconsole":6,"socket.io-client":7,"webrtc":3,"webrtcsupport":4,"wildemitter":2}],2:[function(require,module,exports){
/*
...
(function (exports, io) {
   ...
   * @api public
   */
//send volume usees this packet . -- miletsone altanai 3 
...
function WebRTC(opts) {
    ...
    // We also allow a 'logger' option. It can be any object that implements log, warn, and error methods.
    this.logger = function () {
        // we assume that if you're in debug mode and you didn't pass in a logger, you actually want to log as much as possible.
        if (opts.debug) {
            return opts.logger || console;
        } else {
        // or we'll use your logger which should have its own logic for output. Or we'll return the no-op.
            return opts.logger || mockconsole;
        }
    }();
...
//speaking and stopped speaking using datachannel and hark- alatani milestone4 
    ...
    //Volume chnage function for peer to peer -- milestione altanai 2 
...
// sends message to all - simplest method to send a message - alatani milestone 5
...
},{"./peer":10,"localmedia":11,"mockconsole":6,"util":8,"webrtcsupport":4,"wildemitter":2}],12:[function(require,module,exports){
...
//        console.log ( " ------------ Got a Code from message ");
//    }
};
...
},{"getscreenmedia":16,"getusermedia":14,"hark":15,"mediastream-gain":17,"mockconsole":6,"util":8,"webrtcsupport":4,"wildemitter":2}],18:[function(require,module,exports){
//     Underscore.js 1.6.0
...
// Internal method for processing a new data channel being added by the other peer.
...
},{"sdp-jingle-json":20,"traceablepeerconnection":23,"underscore":18,"util":8,"webrtcsupport":4,"wildemitter":2}],19:[function(require,module,exports){
// created by @HenrikJoreteg
var prefix;
var isChrome = false;
var isFirefox = false;
...
},{"./parsers":25}],15:[function(require,module,exports){
var WildEmitter = require('wildemitter');
...
},{"wildemitter":2}],25:[function(require,module,exports){
...
SimpleWebRTC.prototype.sendControlPackets= function(msg, event , peer, opts){
    ...
    this.webrtc.peers.forEach(function (peer) {
    // alert(" Send Mesage Clicked in simple webrtc "+ msg);     
        if (peer.enableDataChannels) {
...
//Send widget content 
SimpleWebRTC.prototype.sendWidgetPackets= function(msg, event , peer, opts){
     // now use the newly created dtwacahennel
    this.webrtc.peers.forEach(function (peer) {
     //alert(" Send Mesage Clicked in simple webrtc "+ msg);     
        if (peer.enableDataChannels) {
            var dc =  peer.getDataChannel('widgetchannel');
            peer.emit('addChannel', dc);
            if (dc.readyState != 'open') return false;
            dc.send(JSON.stringify({type: 'widgetMessage', message:msg }));
            return true;
        }
